  ...
  return (
    <nav
      className={classes(
        ...
        "after:absolute after:-start-5 after:h-5 after:w-full after:-bottom-5 after:z-90 after:bg-gradient-to-b after:dark:from-gray-900 after:dark:to-transparent after:from-white after:to-transparent"
      )}
    >
      <button
