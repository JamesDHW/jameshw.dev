...
import { ScrollToTopLink } from "components/Common/ScrollToTopLink/ScrollToTopLink";
    ...
    return (
        <div className="flex flex-col px-8">
            <h1 className={classNames(
                "sticky top-20 py-2 z-40 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 text-4xl sm:text-5xl font-bold my-24",
            ...
            <div className="max-w-3xl ml-4">
                <p className="text-gray-800 dark:text-gray-200 font-semibold text-base sm:text-lg mb-24">
                    I help you reduce risk, move faster, and build systems and teams that scale.
                </p>
            </div>
            ...
            <section className="mt-10 space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                    {PROOF_LINKS.map(({ label, href }) => {
                        return (
                            <ScrollToTopLink key={href} href={href} className={PROOF_LINK_CLASSES}>
