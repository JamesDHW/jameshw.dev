...
const CHALLENGES: ChallengeItem[] = [
  ...
  },
  {
    ...
    description:
      "Roadmaps slip and quality degrades as the system and organisation scale faster than the process supporting them.",
  },
  {
...
const APPROACH_DESCRIPTION =
  "A fixed-term, part-time leadership engagement to stabilise delivery, improve decision-making, and set a clear technical direction—without long-term lock-in. Each approach is different depending on your needs.";

const APPROACH_STEPS: ApproachStep[] = [
  {
    title: "Assess and stabilise",
    description:
      "I quickly identify the highest-leverage constraints (architecture, process, team dynamics) and help you remove any bottlenecks and set momentum.",
  },
  {
